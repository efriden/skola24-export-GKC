...
def create_argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "-s", "--start", default=week, type=int, help="start week number"
    )
...
def main():
    ...
    if args.group != None:
        timetable = schedule.get_timetable_for_group(
            args.unit, args.host, args.group, args.year, args.start, args.end
        )
        ...
        timetable = schedule.get_timetable_for_teacher(
            args.unit, args.host, args.teacher, args.year, args.start, args.end
        )
